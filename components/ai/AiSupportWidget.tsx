...
export function AiSupportWidget() {
  ...
  return (
    <div className="pointer-events-none fixed bottom-24 left-3 z-[70] h-14 w-14">
      {supportOpen ? (
        <div className="pointer-events-auto absolute bottom-16 left-0 w-[min(calc(100vw-1.5rem),360px)] origin-bottom-left overflow-hidden rounded-2xl border border-indigo-400/20 bg-[#0c0c16] shadow-[0_24px_80px_rgba(0,0,0,0.45)]">
          <div className="flex h-[min(64vh,520px)] flex-col">
      ...
      >
        <span className="pointer-events-none absolute inset-0 animate-ai-ring rounded-full ring-2 ring-emerald-300/40" />
